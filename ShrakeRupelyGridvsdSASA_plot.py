...
grid_nc = '%s/no_gaussian.nc'%grid_path
...
bsite_file = None
grid_nc_file = f"{ppi_path}/2.redock/4.receptor_grid/2OOB_A:B/no_gaussian.nc"
...
def regplot(trans_scores, delta_sasas, colors, name, num):
    import numpy as np
    ...
    ax.set_title(f'Shrake-Rupley Grid SASA score vs Shrake-Rupley R+L-C Delta SASA {chr(10)} Rotation:{num}{chr(10)} R2: {r_sq}, RMSE: {RMSE}')
...
rotations = {}
r_grid = p.load(open("/media/jim/Research_TWO/FFT_PPI/2.redock/4.receptor_grid/2OOB_A:B/r_grid.p", "rb"))
...
for i,rot_crd in enumerate(lig_rot):
    ...
    name = f'/home/jim/src/p39/fftanalysis/plots/Shrake-Rupley-FullCore/{i}.jpg'

    regplot(trans_scores, delta_sasas, colors, name, i)
    print('plot saved')
    values = {}
...
final = f'/home/jim/src/p39/fftanalysis/plots/Shrake-Rupley-FullCore/2OOB_A.jpg'
p.dump(rotations, open( "/home/jim/src/p39/fftanalysis/plots/Shrake-Rupley-FullCore/rotations.p", "wb" ) )
